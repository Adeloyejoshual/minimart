...
/* ═══════════════════════════════════════════════════════════════════════════
   NAMED ROUTES  (must appear before /:userId routes)
═══════════════════════════════════════════════════════════════════════════ */
...
router.get("/audit-log", verifyAdmin, async (req, res) => {
  ...
  try {
    ...
    const { rows } = await client.query(
      `SELECT
         al.id, al.admin_id, al.admin_name, al.action,
...
router.get("/search-users", verifyAdmin, async (req, res) => {
  ...
  try {
    ...
    console.error("[GET /subscriptions/search-users]", err.message);
...
/* ═══════════════════════════════════════════════════════════════════════════
   :userId PARAM ROUTES  (must appear AFTER all named routes above)
═══════════════════════════════════════════════════════════════════════════ */
...
router.get("/:userId/payments", verifyAdmin, async (req, res) => {
  ...
  try {
    const { rows } = await client.query(
      `SELECT
         pt.id, pt.reference, pt.provider,
