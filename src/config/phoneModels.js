...
const phoneModels = {
  Smartphones: {
    ...
    Asus: ["ROG Phone 8 Pro","ROG Phone 7 Ultimate","ROG Phone 7","ROG Phone 6 Pro","ROG Phone 6","Zenfone 10","Zenfone 9","Zenfone 8"],
    BlackBerry: ["Key2","KeyOne","Passport","Bold","Curve"],
    Blackview: ["Blackview BV9900","Blackview BV9800"],
    BQ: ["BQ Aquaris X","BQ Aquaris U2"],
    BLU: ["BLU G91","BLU G50"],
    CAT: ["CAT S75","CAT S61"],
    Casio: ["Casio G'zOne","Casio Exilim"],
    "Cherry Mobile": ["Flare S7","Flare X"],
    Cubot: ["Cubot X50","Cubot King Kong 7"],
    Doogee: ["Doogee S100","Doogee N30"],
    Energizer: ["Energizer Hardcase H550S","Energizer Power Max P18K"],
    Elephone: ["Elephone U3","Elephone E10"],
    Fairphone: ["Fairphone 5","Fairphone 4"],
    Fly: ["Fly FS511","Fly Cirrus 8"],
    Gionee: ["Gionee M12","Gionee P7"],
    Google: ["Pixel 8 Pro","Pixel 8","Pixel 7 Pro","Pixel 7"],
    Huawei: ["P60 Pro","P50 Pro","P40 Pro Plus","P40 Pro","P40","P30 Pro","P30","Mate 50 Pro","Mate 40 Pro","Mate 30 Pro","Mate 20 Pro"],
    Honor: ["Honor Magic 6","Honor 90","Honor X8a"],
    itel: ["S23 Plus","S23","S21","A58 Pro","A56","A48","A25","A16"],
    Jolla: ["Jolla Phone"],
    Karbonn: ["Karbonn Titanium S9","Karbonn Aura Note"],
    Lenovo: ["Lenovo Legion Y90","Lenovo K14 Note"],
    Motorola: ["Edge 40 Pro","Edge 40","G73","G54","G9 Plus","G8 Plus"],
