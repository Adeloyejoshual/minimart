// /config/locationsByState.js

export const locationsByState = {
  Abia: [
    "Aba North","Aba South","Arochukwu","Bende","Ikwuano","Isiala Ngwa North","Isiala Ngwa South","Isuikwuato",
    "Obi Ngwa","Ohafia","Osisioma Ngwa","Ugwunagbo","Ukwa East","Ukwa West","Umuahia North","Umuahia South",
    "Umu Nneochi"
  ],
  Adamawa: [
    "Demsa","Fufore","Ganye","Girei","Gombi","Guyuk","Hong","Jada","Lamurde","Madagali","Maiha","Mayo Belwa",
    "Michika","Mubi North","Mubi South","Numan","Shelleng","Song","Toungo","Yola North","Yola South"
  ],
  AkwaIbom: [
    "Abak","Eastern Obolo","Eket","Esit Eket","Essien Udim","Etim Ekpo","Etinan","Ibeno","Ibesikpo Asutan","Ibiono‑Ibom",
    "Ika","Ikono","Ikot Abasi","Ikot Ekpene","Ini","Itu","Mbo","Mkpat‑Enin","Nsit‑Atai","Nsit‑Ibom","Nsit‑Ubium",
    "Obot Akara","Okobo","Onna","Oron","Oruk Anam","Ukanafun","Udung‑Uko","Uruan","Urue‑Offong/Oruko","Uyo"
  ],
  Anambra: [
  ...
  Borno: [
    ...
    "Kaga","Kala/Balge","Konduga","Kukawa","Kwaya Kusar","Mafa","Magumeri","Maiduguri","Marte","Mobbar","Monguno",
    "Ngala","Nganzai"
  ],
  CrossRiver: [
    "Abi","Akamkpa","Akpabuyo","Bakassi","Bekwarra","Biase","Boki","Calabar Municipal","Calabar South","Etung",
    "Ikom","Obanliku","Obubra","Obudu","Odukpani","Ogoja","Yakuur","Yala"
  ],
  Delta: [
    ...
    "Sapele","Udu","Ughelli North","Ughelli South","Uvwie","Warri North","Warri South","Warri South West"
  ],
  Ebonyi: [
  ...
  Edo: [
    ...
    "Etsako West","Igueben","Ikpoba‑Okha","Oredo","Orhionmwon","Ovia North‑East","Ovia South‑West","Owan East",
    "Owan West","Uhunmwonde"
  ],
  Ekiti: [
    "Ado Ekiti","Efon","Ekiti East","Ekiti South‑West","Ekiti West","Emure/Ise/Orun","Gbonyin","Ido/Osi","Ijero",
  ...
  Jigawa: [
    "Auyo","Babura","Birnin Kudu","Birnin Magaji","Buji","Dutse","Gagarawa","Garki","Gumel","Guri","Gwaram","Kafin Hausa",
    "Kaugama","Kazaure","Kiri Kasama","Kiyawa","Maigatari","Malam Madori","Miga","Ringim","Roni","Sule Tankarkar",
    "Taura","Yankwashi"
  ],
  Kaduna: [
  ...
  Kano: [
    ...
    "Gabasawa","Garko","Garun Mallam","Gaya","Gezawa","Gwale","Gwarzo","Kabo","Kano Municipal","Karaye","Kibiya","Kiru",
    "Kumbotso","Kunchi","Kura","Madobi","Makoda","Minjibir","Nasarawa","Rano","Rimin Gado","Rogo","Shanono","Sumaila",
    "Takai","Tarauni","Tofa","Tsanyawa","Tudun Wada","Ungogo","Warawa","Wudil"
  ],
  Katsina: [
    "Bakori","Batagarawa","Batsari","Baure","Bindawa","Charanchi","Dandume","Danja","Dan Musa","Daura","Dutsi","Dutsin Ma",
    "Faskari","Funtua","Ingawa","Jibia","Kafur","Kaita","Kankara","Kankia","Katsina","Kurfi","Kusada","Mai'Adua",
  ...
  Lagos: [
    "Agege","Ajeromi‑Ifelodun","Alimosho","Amuwo‑Odofin","Apapa","Badagry","Epe","Eti‑Osa","Ibeju‑Lekki","Ifako‑Ijaye",
  ...
  Osun: [
    ...
    "Egbedore","Ejigbo","Ife Central","Ife East","Ife North","Ife South","Ifelodun","Ila","Ilesha East","Ilesha West",
  ...
  Oyo: [
    ...
    "Kajola","Ogbomosho North","Ogbomosho South","Ogo‑Oluwa","Olorunsogo","Oluyole","Ona‑Ara","Orelope","Ori Ire",
  ...
  Rivers: [
    ...
    "Etche","Gokana","Ikwerre","Khana","Obio/Akpor","Ogba‑Egbema‑Ndoni","Ogu‑Bolo","Okrika","Omumma","Opobo/Nkoro",
    "Oyigbo","Port Harcourt","Tai"
  ],
  Sokoto: [
    "Binji","Bodinga","Dange Shuni","Gada","Goronyo","Gudu","Gwadabawa","Illela","Isa","Kebbe","Kware","Rabah",
    "Sabon Birni","Shagari","Silame","Sokoto North","Sokoto South","Tambuwal","Tangaza","Tureta","Wamakko","Wurno",
    "Yabo"
  ],
  Taraba: [
    "Ardo Kola","Bali","Donga","Gashaka","Gassol","Ibi","Jalingo","Karim Lamido","Kurmi","Lau","Sardauna","Takum",
  ...
  Zamfara: [
    "Anka","Bakura","Birnin Magaji/Kiyaw","Bukkuyum","Bungudu","Tsafe","Gummi","Gusau","Kaura Namoda","Maradun",
...
export type LocationsByState = typeof locationsByState;
