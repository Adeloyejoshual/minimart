...
function ParticleCanvas() {
  ...
  useEffect(() => {
    ...
    const onMove  = (e) => { const r = canvas.getBoundingClientRect(); mx.current = { x: e.clientX - r.left, y: e.clientY - r.top }; };
...
function OtpCells({ value, onChange, disabled, hasError }) {
  ...
  return (
    <div className={`ap-otp-group ${hasError ? "ap-otp-group--error" : ""}`}
...
function Spinner() {
  return (
    <svg className="ap-spinner" width="19" height="19" viewBox="0 0 24 24"
...
/* ═══════════════════════════════════════════════════════════════
   LEFT PANEL  (shared between all modes)
═══════════════════════════════════════════════════════════════ */
function LeftPanel() {
  return (
...
export default function AuthPage({ setUser }) {
  ...
  /* ════════════════════════════════════════════════════════════
     REGISTER → auto-send OTP → switch mode
  ════════════════════════════════════════════════════════════ */
              ...
              <div className="ap-otp-resend">
                <div>
                  {resendLeft === 0 ? (
                    ...
                    <button type="button" className="ap-otp-resend__btn" onClick={handleResend}>
