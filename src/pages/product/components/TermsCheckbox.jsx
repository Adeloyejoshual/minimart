/**
 * src/pages/product/components/TermsCheckbox.jsx
 * Custom Terms & Conditions checkbox
 * - Visible orange-filled box when checked
 * - Shake + red border + error message on submit without agreement
 * - Works with AddProduct.css .terms-* classes
 */
