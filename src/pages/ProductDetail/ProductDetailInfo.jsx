...
/* ── SVG Icons (transparent / stroke-only) ────────────────── */
    ...
    <div className="pdi">
        ...
        <div className="pdi-engagement" aria-label="Listing stats">
          {product.views > 0 && (
            <span className="pdi-eng-item" aria-label={`${product.views} views`}>
              <IconEye />
              <span>{compactNum(product.views)}</span>
            </span>
          )}
          ...
          {product.favorites_count > 0 && (
            <span className="pdi-eng-item" aria-label={`${product.favorites_count} saves`}>
              <IconHeart />
              <span>{compactNum(product.favorites_count)}</span>
            </span>
          )}
          ...
          {posted && (
            <span className="pdi-eng-item pdi-eng-item--time"
      ...
      <div className="pdi-price-row">
        ...
        {product.original_price != null && product.original_price > product.price && (
          <>
            <span className="pdi-price-old">
              {symbol}{fmt(product.original_price)}
            </span>
            {product.discount_percent > 0 && (
              <span className="pdi-price-off">
        ...
        {product.negotiable && (
          <span className="pdi-negotiable" aria-label="Price negotiable">
            Negotiable
          </span>
        )}
      </div>
