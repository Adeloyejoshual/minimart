    ...
    <>
      <style>{`
        ...
        .pa-cat-btn{
          ...
          background:#fafaf8;cursor:pointer;font-size:12px;font-weight:600;color:#555;transition:all .15s;
        }
                  ...
                  <>
                    ...
                    <div className="pa-field">
                      ...
                      <div className="pa-list-wrap">
                        ...
                        <button type="button" className="pa-add-btn" onClick={() => addList(setKeyFeatures, keyFeatures, 8)}>
                          + Add Feature
                        </button>
                      </div>
                    </div>
                    ...
                    <div className="pa-field">
                      ...
                      <div className="pa-list-wrap">
                        ...
                        <button type="button" className="pa-add-btn" onClick={() => addList(setWhatsInBox, whatsInBox, 10)}>
                          + Add Box Item
                        </button>
                      </div>
                    </div>
