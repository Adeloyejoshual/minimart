...
import { FiChevronLeft, FiChevronRight, FiCheckCircle, FiArrowLeft } from "react-icons/fi";
...
export default function PostAds({ user }) {
  ...
  /* ── Auto-save draft (includes step) ── */
  useEffect(() => {
    localStorage.setItem(DRAFT_KEY, JSON.stringify({
      title, description, category, keyFeatures,
      specifications, whatsInBox, variants,
      basePrice, originalPrice, step,
    }));
  }, [
    title, description, category, keyFeatures,
    specifications, whatsInBox, variants,
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (!err.response)
        ...
        toast.error(err.response.data?.message || "Listing blocked.");
  ...
  return (
    <div className="pa-page">
      ...
      {posted ? (
        ...
        <>
          {/* Step bar sits just below the top bar */}
            ...
            {step === 2 && (
              <>
                ...
                <p className="pa-section-sub">
                  Clear titles rank higher and get more clicks.
                </p>
                ...
                <div className="pa-field">
                  ...
                  />
                  <p
                    className={`pa-char-count ${
                      title.length > 70 ? "pa-char-count--warn" : ""
                    }`}
                  >
                    {title.length}/80
                  </p>
                ...
                <div className="pa-field">
                  ...
                  <p
                    className={`pa-char-count ${
                      description.length > 460 ? "pa-char-count--warn" : ""
                    }`}
                  >
                ...
                <div className="pa-field">
                  ...
                  <div className="pa-list-wrap">
                    ...
                    <button
                      ...
                      onClick={() =>
                        addList(setKeyFeatures, keyFeatures, 8)
                      }
                    >
                      + Add Feature
                    </button>
                ...
                <div className="pa-field">
                  ...
                  <div className="pa-list-wrap">
                    ...
                    <button
                      ...
                      className="pa-add-btn"
                      onClick={() =>
                        addList(setWhatsInBox, whatsInBox, 10)
                      }
                    >
                      + Add Box Item
                    </button>
                  ...
                  <div className="pa-cat-grid">
                    {categories.map((c) => (
                      <button
                        key={c.id}
                        type="button"
                        className={`pa-cat-btn ${
                          category === c.id ? "pa-cat-btn--active" : ""
                        }`}
