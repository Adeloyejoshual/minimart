...
const [selectionStep, setSelectionStep] = useState(null); // "subCategory", "brand", "model", "condition", "usedDetail", "state", "city"
...
setForm(prev => ({
...prev,
images: prev.images.filter((, i) => i !== idx),
previewImages: prev.previewImages.filter((, i) => i !== idx)
}));
};
