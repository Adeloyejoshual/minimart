...
const FilterSidebar = memo(function FilterSidebar({
  open, onClose, aggregations, draft, onDraftChange, onApply, onReset,
}) {
  const {
    price      = { min: 0, max: 0 },
    conditions = [],
  ...
  return (
    <>
      {open && (
        <div className="sp-filter-overlay" onClick={onClose} aria-hidden="true" />
      )}
...
function EmptyState({ query, onReset }) {
  return (
    <div className="sp-empty">
      ...
      <p className="sp-empty-sub">We couldn't find anything matching your search.</p>
        ...
        <div className="sp-header-top">
          ...
          <div style={{ minWidth: 0, flex: 1 }}>
            ...
            <h1 className="sp-title">
              {loading ? (
                <>Searching <span className="sp-title-query">"{query}"</span>…</>
              ) : meta?.total > 0 ? (
                <>
          ...
          <div className="sp-results">
            ...
            {error && !loading && (
              <div className="sp-error" role="alert">
                ...
                <button className="sp-retry-btn" onClick={fetchResults} type="button">
                  Try again
                </button>
              </div>
            )}
            ...
            {!loading && !error && products.length > 0 && (
              <>
                ...
                <div style={{
                  ...
                  borderTop: "1px solid var(--sp-glass-border)", marginTop: "24px",
                }}>
                  <button
