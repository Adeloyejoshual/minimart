 ...
 * Single top banner ad (Adsterra) — no popunder, no in-feed, no bottom ads.
 */
...
/* ═══════════════════════════════════════════════════════════════
   🎯 AD CONFIGURATION
   Toggle ads on/off here. Only top banner is enabled by default.
═══════════════════════════════════════════════════════════════ */
const AD_CONFIG = {
  topBanner   : true,   // ✅ Enabled
  inFeedBanner: false,  // ❌ Disabled
  bottomBanner: false,  // ❌ Disabled
  popunder    : false,  // ❌ Disabled
};

/* ── Adsterra ad keys ── */
const AD_KEYS = {
  topBanner: "YOUR_TOP_BANNER_KEY_HERE", // Replace with real key
};
  ...
  return (
    <>
      ...
      <div className="sp-page">
        ...
        {/* ══════════════════════════════════════════════════════
            🎯 TOP AD BANNER (Adsterra) — the only ad on this page
        ══════════════════════════════════════════════════════ */}
        {AD_CONFIG.topBanner && (
          <AdsterraBanner
