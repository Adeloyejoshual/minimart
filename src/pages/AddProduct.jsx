...
export default function AddProduct() {
  ...
  const dynamicFields = dynamicOptions.fields || [];

  // ---------------- STATE & CITY DROPDOWNS ----------------
  const locationsByState = dynamicOptions.location || {}; // <-- from selected category
  ...
  // ---------------- OPTIONS MAP ----------------
  const optionsMap = {
    brand: dynamicOptions.brands || [],
    model: dynamicOptions.models?.[form.dynamic.brand] || [],
    color: dynamicOptions.colors || [],
    condition: dynamicOptions.conditions || [],
    used_detail: dynamicOptions.usedDetails || [],
    ram: dynamicOptions.ram || [],
    storage: dynamicOptions.storage || [],
    sim: dynamicOptions.sims || [],
    features: dynamicOptions.features || [],
    year: dynamicOptions.years || [],
    engine: dynamicOptions.engine || [],
    fuel_type: dynamicOptions.fuel_type || [],
  };
